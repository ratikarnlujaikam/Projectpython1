...
from pairplot_generator import fetch_and_plot 
...
app.add_url_rule('/api/fetch_and_plot/<model>/<line>/<start>/<end>/<selecteKPOV>/<selecteKPIV>', 'fetch_and_plot', fetch_and_plot)
