...
def get_Process():
    try:
        ...
        # ดึงข้อมูลจาก SQL
        cursor.execute(
            " SELECT  distinct [Part] as Process FROM [DataforAnalysis].[dbo].[parameters]inner join [Component_Master].[dbo].[Master_matchings] on [parameters].[Parameter] = [Master_matchings].[Parameter]")
